              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="">
                      <?php 
                        $sql = "SELECT dep_id, dep_name FROM department_info WHERE 1 ";
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <ul class="nav nav-tabs nav-justified nav-tabs-custom">
            ...
            <li><a href="admin-manage-department.php">Manage Departments</a></li>
          </ul>
          <div class="gap"></div>
            ...
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                  ...
                  <td><?php 
                        $dep_id = $row['user_dep_id'];
                        $sql2 = "SELECT dep_name FROM department_info WHERE dep_id = '$dep_id' ";
                        $info2 = $obj_admin->manage_all_info($sql2);   
                        while($row2 = $info2->fetch(PDO::FETCH_ASSOC)){ 
                          echo $row2['dep_name']; 
                        } 
                      ?>    
                   </td>
                  <td>
                    ...
                    <a title="Delete" href="?delete_user=delete_user&admin_id=<?php echo $row['user_id']; ?>" onclick=" return check_delete();"><span class="glyphicon glyphicon-trash"></span>
                    </a></td>
                </tr>
...
?>
<!-- finally end admin-manage-user code Developer Adam Gebreyohannes-->